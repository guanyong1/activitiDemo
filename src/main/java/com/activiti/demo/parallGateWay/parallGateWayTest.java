package com.activiti.demo.parallGateWay;
 ...
 * @Modified By:
 */
public class parallGateWayTest {
    ...
    public void deploymentProcessDefinittion(){
        InputStream inputStreamBpmn = this.getClass().getClassLoader().getResourceAsStream("parallGateWay/parallGateWay.bpmn");
        ...
        Deployment deployment = processEngine.getRepositoryService()
                                                .createDeployment()
                                                .name("并行网关")
                                                .addInputStream("parallGateWay.bpmn",inputStreamBpmn)
    ...
    public void startProcessInstance(){
        ProcessInstance processInstance = processEngine.getRuntimeService()
                        .startProcessInstanceByKey("parallGateWay");
